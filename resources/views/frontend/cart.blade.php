                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="{{ asset('/') }}/assets/front-end/img/product-thumb-1.jpg" class="recent-thumb"
                                alt="">
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145"
                                                        ...
                                                        src="{{ asset('/') }}/assets/front-end/img/product-thumb-2.jpg"></a>
                                            </td>
                                    ...
                                    <ul class="products">
                                        <li class="product">
                                            <a href="single-product.html">
                                                <img width="325" height="325" alt="T_4_front"
                                                    ...
                                                    src="{{ asset('/') }}/assets/front-end/img/product-2.jpg">
                                        ...
                                        <li class="product">
                                            <a href="single-product.html">
                                                <img width="325" height="325" alt="T_4_front"
                                                    class="attachment-shop_catalog wp-post-image"
                                                    src="{{ asset('/') }}/assets/front-end/img/product-4.jpg">
                                                <h3>Ship Your Idea</h3>
                                                <span class="price"><span class="amount">£20.00</span></span>
                                            </a>
