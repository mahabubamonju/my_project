...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/') }}/assets/front-end/style.css">
                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="{{route('dashboard')}}"><i class="fa fa-user"></i> Login</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="./"><img src="{{ asset('/') }}/assets/front-end/img/logo.png"></a></h1>
                    </div>
                </div>
